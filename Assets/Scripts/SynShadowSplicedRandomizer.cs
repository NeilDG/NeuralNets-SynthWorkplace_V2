...
public class SynShadowSplicedRandomizer : MonoBehaviour
{
    ...
    private void RandomizeShadowMatte()
    {
        ...
        {
            this.spriteInstances[i].sprite = DatasetLoader.GetInstance().GetRandomSplicedSprite();
        }
    }
    ...
    private void RandomizeShadowMatteTransform()
    {
        ...
        for (int i = 0; i < this.spriteInstances.Count; i++)
        {
            ...
            this.spriteInstances[i].transform.localScale = Vector3.one * 2.5f;
